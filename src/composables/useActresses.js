...
const KNOWN_ACTRESSES = new Set([
  // A
  'Abella Danger', 'AJ Applegate', 'Aaliyah Hadid', 'Aaliyah Love', 'Abigaile Johnson',
  'Adira Allure', 'Adria Rae', 'Adriana Chechik', 'Aletta Ocean', 'Alex Blake',
  'Alex Chance', 'Alex Coal', 'Alex De La Flor', 'Alex Gonz', 'Alex Grey',
  'Alex Harper', 'Alex Jett', 'Alex Jones', 'Alex Legend', 'Alex Lynn',
  'Alex Mack', 'Alex Moreno', 'Alex Tanner', 'Alex Victor', 'Alexa Flexy',
  'Alexa Grace', 'Anna Katz', 'Angela White', 'Anissa Kate', 'Anya Olsen',
  'Ariana Marie', 'Aria Alexander', 'Ariella Ferrera', 'Ashley Adams',
  'Ashley Fires', 'Ashley Lane', 'Aubrey Gold', 'Ava Addams', 'Ava Taylor',
  // B
  'Bella Rolland', 'Bella Rose', 'Brenna Sparks', 'Brianna Beach',
  'Bridgette B', 'Britney Amber', 'Brooklyn Chase', 'Bunny Colby',
  // C
  'Cadey Mercury', 'Candice Dare', 'Capri Cavanni', 'Casey Calvert',
  'Cassidy Banks', 'Chanel Preston', 'Charity Crawford', 'Chloe Amour',
  'Chloe Cherry', 'Chloe Foster', 'Chloe Scott', 'Chloe Surreal',
  'Christy White', 'Codi Vore', 'Cory Chase', 'Crystal Rush',
  // D
  'Dani Daniels', 'Dana DeArmond', 'Dana Vespoli', 'Dani Jensen',
  'Daniella Schiffer', 'Darcie Dolce', 'Dava Foxx', 'Daya Knight',
  'Dee Williams', 'Diamond Jackson', 'Dillion Harper', 'Dolly Little',
  // E
  'Eden Ivy', 'Elena Koshka', 'Eliza Ibarra', 'Ella Hughes',
  'Ella Knox', 'Emily Willis', 'Emma Hix', 'Eva Lovia',
  'Eva Notty', 'Evelyn Claire',
  // F
  'Faye Reagan', 'Felicity Feline', 'Fiona Cooper',
  // G
  'Gabbie Carter', 'Gia Derza', 'Gianna Dior', 'Gina Valentina',
  'Giselle Palmer', 'Gracie May Green', 'Gwen Stark',
  // H
  'Haley Reed', 'Harmony Wonder', 'Hazel Moore', 'Heather Starlet',
  'Hitomi Tanaka', 'Holly Hendrix', 'Holly Michaels', 'Honey Gold',
  // I
  'Ivy Lebelle', 'Ivy Wolfe',
  // J
  'Jade Kush', 'Jade Nile', 'Jasmine Jae', 'Jenna Sativa',
  'Jenna Starr', 'Jessa Rhodes', 'Jillian Janson', 'Jillian Jacobs',
  'Joanna Angel', 'Jordi El Nino Polla', 'Jordyn Woodland', 'Joseline Kelly',
  'Juelz Ventura', 'Julia Ann', 'Julia De Lucia', 'Jynx Maze',
  // K
  'Kali Roses', 'Karla Kush', 'Karlee Grey', 'Karma Rx',
  'Kasey Warner', 'Kat Dior', 'Katalina Kyle', 'Kate England',
  'Katie Kush', 'Kendra Lust', 'Kendra Spade', 'Kenzie Reeves',
  'Khloe Kapri', 'Kimmy Granger', 'Kira Noir', 'Kissa Sins',
  'Kylie Page', 'Kylie Quinn',
  // L
  'Lana Rhoades', 'Lana Roy', 'Layla London', 'Leah Gotti',
  'Lena Paul', 'Lexi Belle', 'Lexi Luna', 'Lily Adams',
  'Lily Cade', 'Lily Larimar', 'Lily Rader', 'Lina Luxa',
  'Little Caprice', 'Liya Silver', 'Lola Fae', 'Luna Star',
  // M
  'Maddy O\'Reilly', 'Maddy May', 'Maddy Rose', 'Maitland Ward',
  'Mandy Muse', 'Marley Brinx', 'Maya Bijou', 'Maya Kendrick',
  'Megan Rain', 'Melissa Moore', 'Mia Khalifa', 'Mia Malkova',
  'Mia Melano', 'Mia Monroe', 'Mia Sol', 'Mila Azul',
  'Mila Monet', 'Mischa Brooks', 'Monique Alexander', 'Monroe Foxx',
  // N
  'Naomi Swann', 'Natasha Nice', 'Natalia Starr', 'Natalie Mars',
  'Nikki Benz', 'Nina Elle', 'Nina North', 'Nina Skyy',
  // O
  'Olivia Austin', 'Olivia Nova',
  // P
  'Paige Owens', 'Paisley Paige', 'Penny Pax', 'Phoenix Marie',
  'Piper Perri', 'Pristine Edge', 'Puma Swede',
  // R
  'Rachel Starr', 'Rae Lil Black', 'Rebecca More', 'Remy Lacroix',
  'Riley Reid', 'Riley Star', 'Romi Rain', 'Rosalyn Sphinx',
  'Roxy Raye', 'Ryan Ryans',
  // S
  'Sara Jay', 'Sara Luvv', 'Sarah Banks', 'Sarah Vandella',
  'Scarlet Chase', 'Scarlet Red', 'Scarlit Scandal', 'Sera Ryder',
  'Shae Summers', 'Sharon Lee', 'Shyla Jennings', 'Sierra Skye',
  'Skylar Snow', 'Sloan Harper', 'Sophia Leone', 'Sophia Traxler',
  'Stella Cox', 'Stella May', 'Stephanie West', 'Summer Brielle',
  'Syren De Mer',
  // T
  'Tara Ashley', 'Tasha Reign', 'Tegan Presley', 'Tiffany Tatum',
  'Tori Black', 'Tru Kait', 'Tyler Nixon',
  // V
  'Valentina Nappi', 'Valentina Ricci', 'Vanessa Cage', 'Veronica Avluv',
  'Veronica Rodriguez', 'Vicki Chase', 'Victoria June', 'Victoria Voxxx',
  'Vina Sky', 'Violet Myers', 'Violet Starr',
  // W
  'Whitney Wright', 'Willow Hayes',
  // Y
  'Yhivi', 'Yurizan Beltran',
  // Z
  'Zoe Bloom', 'Zoe Parker', 'Zoe Voss',
]);
...
const MALE_ACTORS = new Set([
  'Johnny Sins', 'Manuel Ferrara', 'Mick Blue', 'James Deen',
  'Keiran Lee', 'Danny D', 'Rocco Siffredi', 'Evan Stone',
  'Tommy Gunn', 'Mark Wood', 'Chris Strokes', 'Xander Corvus',
  'Bruce Venture', 'Ramon Nomar', 'Tony T', 'Steve Holmes',
  'Erik Everhard', 'Marcus London', 'John Strong', 'Bill Bailey',
]);
...
const NON_NAME_WORDS = new Set([
  ...
  'hd', '4k', 'full', 'part', 'episode', 'series', 'season', 'collection',
  'best', 'top', 'new', 'latest', 'popular', 'trending', 'hot', 'sexy',
...
function isValidPersonName(name) {
  ...
  if (lowerName.startsWith('/') || lowerName.startsWith('-') || 
      lowerName.startsWith('an ') || lowerName.startsWith('a ') ||
      lowerName.startsWith('the ') || lowerName.startsWith('bokep') ||
      lowerName.startsWith('indonesia') || lowerName.startsWith('indo')) return false;
...
function extractActressNames(video) {
  ...
  const allKeywords = keywords.split(',').map(k => k.trim()).filter(k => k);
  
  // Extract from categories (sometimes actresses are listed here)
  const categories = (video.categories || []).map(c => 
  ...
  for (const actress of KNOWN_ACTRESSES) {
    ...
    const allWordsMatch = actressWords.every(word => 
      allText.includes(word) || title.includes(word) || keywords.includes(word)
    );
    
    if (allWordsMatch && (title.includes(actressLower) || keywords.includes(actressLower) || allText.includes(actressLower))) {
      names.add(actress);
    }
  }
...
export function useActresses() {
  ...
  async function extractAllActresses() {
    ...
    try {
      ...
      try {
        localStorage.setItem('extracted_actresses', JSON.stringify(actresses.value));
      } catch (e) {
