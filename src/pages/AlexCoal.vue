    ...
    <div class="actor-content">
      <div class="actor-page">
        <div class="page-header">
          <h1 class="page-title">Alex Coal</h1>
          <p class="page-subtitle">Browse all Alex Coal videos</p>
        </div>
...
function goToPage(page) {
	...
	searchVideos("alex coal", page, { order: "most-popular" });
...
onMounted(() => {
	searchVideos("alex coal", 1, { order: "most-popular" });
});
</script>
