<template>
  <div class="milf-page-container">
    <CategorySidebar :is-open="sidebarOpen" @filter-change="handleFilterChange" />
    <div class="milf-content">
      <div class="milf-page">
        <div class="page-header">
          <h1 class="page-title">MILF</h1>
          <p class="page-subtitle">Browse all MILF videos</p>
        </div>
...
function goToPage(page) {
  ...
  searchVideos('milf', page, { order: 'most-popular' });
  window.scrollTo({ top: 0, behavior: 'smooth' });
}
onMounted(() => { searchVideos('milf', 1, { order: 'most-popular' }); });
</script>

<style scoped>
.milf-page-container { display: flex; position: relative; align-items: flex-start; gap: 0; }
.milf-content { flex: 1; min-width: 0; }
.milf-page { width: 100%; padding: 40px; margin: 0 auto; max-width: 1600px; }
@media (max-width: 1024px) { .milf-content { margin-left: 0; } }
...
@media (max-width: 1024px) { .milf-page { padding: 24px; } }
@media (max-width: 768px) {
  .milf-page { padding: 16px; }
