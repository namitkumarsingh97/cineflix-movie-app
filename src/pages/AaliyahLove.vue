    ...
    <div class="actor-content">
      <div class="actor-page">
        <div class="page-header">
          <h1 class="page-title">Aaliyah Love</h1>
          <p class="page-subtitle">Browse all Aaliyah Love videos</p>
        </div>
...
function goToPage(page) {
  ...
  searchVideos('aaliyah love', page, { order: 'most-popular' });
...
onMounted(() => {
  searchVideos('aaliyah love', 1, { order: 'most-popular' });
});
</script>
