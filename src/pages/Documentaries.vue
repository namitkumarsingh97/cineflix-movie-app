    ...
    <div class="category-content">
      <div class="category-page">
        <div class="page-header">
          ...
          <p class="page-subtitle">Browse educational and behind-scenes documentaries</p>
        </div>
...
function goToPage(page) { if (page === '...' || page < 1 || page > totalPages.value) return; searchVideos('documentary', page, { order: 'most-popular' }); window.scrollTo({ top: 0, behavior: 'smooth' }); }
onMounted(() => { searchVideos('documentary', 1, { order: 'most-popular' }); });
</script>
<style scoped>
