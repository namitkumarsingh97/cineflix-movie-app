    ...
    <div class="actor-content">
      <div class="actor-page">
        <div class="page-header">
          <h1 class="page-title">Alex De La Flor</h1>
          <p class="page-subtitle">Browse all Alex De La Flor videos</p>
        </div>
...
function goToPage(page) {
	...
	searchVideos("alex de la flor", page, { order: "most-popular" });
...
onMounted(() => {
	searchVideos("alex de la flor", 1, { order: "most-popular" });
});
</script>
