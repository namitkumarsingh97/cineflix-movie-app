    ...
    <div class="actor-content">
      <div class="actor-page">
        <div class="page-header">
          <h1 class="page-title">Alexa Flexy</h1>
          <p class="page-subtitle">Browse all Alexa Flexy videos</p>
        </div>
...
function goToPage(page) {
  ...
  searchVideos('alexa flexy', page, { order: 'most-popular' });
...
onMounted(() => {
  searchVideos('alexa flexy', 1, { order: 'most-popular' });
});
</script>
