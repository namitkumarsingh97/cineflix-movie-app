<template>
  <div class="pov-page-container">
    <CategorySidebar :is-open="sidebarOpen" @filter-change="handleFilterChange" />
    <div class="pov-content">
      <div class="pov-page">
        <div class="page-header">
          <h1 class="page-title">POV</h1>
          <p class="page-subtitle">Browse all POV videos</p>
        </div>
...
function goToPage(page) {
  ...
  searchVideos('pov', page, { order: 'most-popular' });
  window.scrollTo({ top: 0, behavior: 'smooth' });
}
onMounted(() => { searchVideos('pov', 1, { order: 'most-popular' }); });
</script>

<style scoped>
.pov-page-container { display: flex; position: relative; align-items: flex-start; gap: 0; }
.pov-content { flex: 1; min-width: 0; }
.pov-page { width: 100%; padding: 40px; margin: 0 auto; max-width: 1600px; }
@media (max-width: 1024px) { .pov-content { margin-left: 0; } }
...
@media (max-width: 1024px) { .pov-page { padding: 24px; } }
@media (max-width: 768px) {
  .pov-page { padding: 16px; }
