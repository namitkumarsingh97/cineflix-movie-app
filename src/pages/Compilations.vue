    ...
    <div class="category-content">
      <div class="category-page">
        <div class="page-header">
          ...
          <p class="page-subtitle">Browse best moments collections</p>
        </div>
...
function goToPage(page) { if (page === '...' || page < 1 || page > totalPages.value) return; searchVideos('compilation', page, { order: 'most-popular' }); window.scrollTo({ top: 0, behavior: 'smooth' }); }
onMounted(() => { searchVideos('compilation', 1, { order: 'most-popular' }); });
</script>
<style scoped>
