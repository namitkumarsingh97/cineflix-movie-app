<template>
  <div class="anal-page-container">
    ...
    <div class="anal-content">
      ...
      <h1 class="page-title">Anal</h1>
      <p class="page-subtitle">Browse all Anal videos</p>
    </div>
...
function goToPage(page) {
	...
	searchVideos("anal", page, { order: "most-popular" });
...
onMounted(() => {
	searchVideos("anal", 1, { order: "most-popular" });
});
</script>
