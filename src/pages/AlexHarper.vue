    ...
    <div class="actor-content">
      <div class="actor-page">
        <div class="page-header">
          <h1 class="page-title">Alex Harper</h1>
          <p class="page-subtitle">Browse all Alex Harper videos</p>
        </div>
...
function goToPage(page) {
	...
	searchVideos("alex harper", page, { order: "most-popular" });
...
onMounted(() => {
	searchVideos("alex harper", 1, { order: "most-popular" });
});
</script>
