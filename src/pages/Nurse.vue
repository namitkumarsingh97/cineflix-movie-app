    ...
    <div class="nurse-content">
      <div class="nurse-page">
        <div class="page-header">
          ...
          <p class="page-subtitle">Browse all Nurse videos</p>
        </div>
...
function goToPage(page) {
  ...
  searchVideos('nurse', page, { order: 'most-popular' });
  window.scrollTo({ top: 0, behavior: 'smooth' });
}
onMounted(() => { searchVideos('nurse', 1, { order: 'most-popular' }); });
</script>

<style scoped>
.nurse-page-container { display: flex; position: relative; align-items: flex-start; gap: 0; }
.nurse-content { flex: 1; min-width: 0; }
.nurse-page { width: 100%; padding: 40px; margin: 0 auto; max-width: 1600px; }
@media (max-width: 1024px) { .nurse-content { margin-left: 0; } }
...
@media (max-width: 1024px) { .nurse-page { padding: 24px; } }
@media (max-width: 768px) {
  .nurse-page { padding: 16px; }
