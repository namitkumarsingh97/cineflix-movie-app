<template>
  <div class="squirt-page-container">
    <CategorySidebar :is-open="sidebarOpen" @filter-change="handleFilterChange" />
    <div class="squirt-content">
      <div class="squirt-page">
        <div class="page-header">
          <h1 class="page-title">Squirt</h1>
          <p class="page-subtitle">Browse all Squirt videos</p>
        </div>
...
function goToPage(page) {
  ...
  searchVideos('squirt', page, { order: 'most-popular' });
  window.scrollTo({ top: 0, behavior: 'smooth' });
}
onMounted(() => { searchVideos('squirt', 1, { order: 'most-popular' }); });
</script>

<style scoped>
.squirt-page-container { display: flex; position: relative; align-items: flex-start; gap: 0; }
.squirt-content { flex: 1; min-width: 0; }
.squirt-page { width: 100%; padding: 40px; margin: 0 auto; max-width: 1600px; }
@media (max-width: 1024px) { .squirt-content { margin-left: 0; } }
...
@media (max-width: 1024px) { .squirt-page { padding: 24px; } }
@media (max-width: 768px) {
  .squirt-page { padding: 16px; }
