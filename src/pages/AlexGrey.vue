    ...
    <div class="actor-content">
      <div class="actor-page">
        <div class="page-header">
          <h1 class="page-title">Alex Grey</h1>
          <p class="page-subtitle">Browse all Alex Grey videos</p>
        </div>
...
function goToPage(page) {
  ...
  searchVideos('alex grey', page, { order: 'most-popular' });
...
onMounted(() => {
  searchVideos('alex grey', 1, { order: 'most-popular' });
});
</script>
