    ...
    <div class="actor-content">
      <div class="actor-page">
        <div class="page-header">
          <h1 class="page-title">Alex Victor</h1>
          <p class="page-subtitle">Browse all Alex Victor videos</p>
        </div>
...
function goToPage(page) {
	...
	searchVideos("alex victor", page, { order: "most-popular" });
...
onMounted(() => {
	searchVideos("alex victor", 1, { order: "most-popular" });
});
</script>
