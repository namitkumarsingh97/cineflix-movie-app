<template>
  <div class="amateur-page-container">
    <!-- Category Sidebar -->
    <CategorySidebar 
      :is-open="sidebarOpen" 
    ...
    <div class="amateur-content">
      <div class="amateur-page">
        <div class="page-header">
      <h1 class="page-title">Amateur</h1>
      <p class="page-subtitle">Browse all Amateur videos</p>
    </div>
...
function goToPage(page) {
	...
	searchVideos("amateur", page, { order: "most-popular" });
...
onMounted(() => {
	searchVideos("amateur", 1, { order: "most-popular" });
});
</script>

<style scoped>
.amateur-page-container {
  display: flex;
  position: relative;
