<template>
  <div class="double-penetration-page-container">
    <!-- Category Sidebar -->
    <CategorySidebar 
      :is-open="sidebarOpen" 
    ...
    <div class="double-penetration-content">
      <div class="double-penetration-page">
        <div class="page-header">
      <h1 class="page-title">Double Penetration</h1>
      <p class="page-subtitle">Browse all Double Penetration videos</p>
    </div>
...
function goToPage(page) {
  ...
  searchVideos('double penetration', page, { order: 'most-popular' });
...
onMounted(() => {
  searchVideos('double penetration', 1, { order: 'most-popular' });
});
</script>

<style scoped>
.double-penetration-page-container {
  display: flex;
  position: relative;
...
.double-penetration-content {
  flex: 1;
  min-width: 0;
}

.double-penetration-page {
  width: 100%;
  padding: 40px;
  margin: 0 auto;
  max-width: 1600px;
