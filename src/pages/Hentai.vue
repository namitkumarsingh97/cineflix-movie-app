<template>
  <div class="hentai-page-container">
    <CategorySidebar :is-open="sidebarOpen" @filter-change="handleFilterChange" />
    <div class="hentai-content">
      <div class="hentai-page">
        <div class="page-header">
          <h1 class="page-title">Hentai</h1>
          <p class="page-subtitle">Browse all Hentai videos</p>
        </div>
...
<style scoped>
.hentai-page-container { display: flex; position: relative; align-items: flex-start; gap: 0; }
.hentai-content { flex: 1; min-width: 0; }
.hentai-page { width: 100%; padding: 40px; margin: 0 auto; max-width: 1600px; }
@media (max-width: 1024px) { .hentai-content { margin-left: 0; } }
...
@media (max-width: 1024px) { .hentai-page { padding: 24px; } }
@media (max-width: 768px) {
  .hentai-page { padding: 16px; }
