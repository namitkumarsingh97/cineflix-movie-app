    ...
    <div class="actor-content">
      <div class="actor-page">
        <div class="page-header">
          <h1 class="page-title">Alex Mack</h1>
          <p class="page-subtitle">Browse all Alex Mack videos</p>
        </div>
...
function goToPage(page) {
  ...
  searchVideos('alex mack', page, { order: 'most-popular' });
...
onMounted(() => {
  searchVideos('alex mack', 1, { order: 'most-popular' });
});
</script>
