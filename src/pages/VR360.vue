    ...
    <div class="category-content">
      <div class="category-page">
        <div class="page-header">
          <h1 class="page-title">VR/360° Videos</h1>
          <p class="page-subtitle">Browse all VR and 360° immersive videos</p>
        </div>
...
function goToPage(page) {
  ...
  searchVideos('vr 360', page, { order: 'most-popular' });
...
onMounted(() => {
  searchVideos('vr 360', 1, { order: 'most-popular' });
});
</script>
