    ...
    <div class="category-content">
      <div class="category-page">
        <div class="page-header">
          ...
          <p class="page-subtitle">Browse exclusive behind the scenes content</p>
        </div>
...
function goToPage(page) { if (page === '...' || page < 1 || page > totalPages.value) return; searchVideos('behind the scenes', page, { order: 'most-popular' }); window.scrollTo({ top: 0, behavior: 'smooth' }); }
onMounted(() => { searchVideos('behind the scenes', 1, { order: 'most-popular' }); });
</script>
<style scoped>
