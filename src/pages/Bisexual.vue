<template>
  <div class="bisexual-page-container">
    <!-- Category Sidebar -->
    <CategorySidebar 
      :is-open="sidebarOpen" 
    ...
    <div class="bisexual-content">
      <div class="bisexual-page">
        <div class="page-header">
          <h1 class="page-title">Bisexual</h1>
          <p class="page-subtitle">Browse all Bisexual videos</p>
        </div>
...
function goToPage(page) {
  ...
  searchVideos('bisexual', page, { order: 'most-popular' });
...
onMounted(() => {
  searchVideos('bisexual', 1, { order: 'most-popular' });
});
</script>

<style scoped>
.bisexual-page-container {
  display: flex;
  position: relative;
