    ...
    <div class="actor-content">
      <div class="actor-page">
        <div class="page-header">
          <h1 class="page-title">Aletta Ocean</h1>
          <p class="page-subtitle">Browse all Aletta Ocean videos</p>
        </div>
...
function goToPage(page) {
	...
	searchVideos("aletta ocean", page, { order: "most-popular" });
...
onMounted(() => {
	searchVideos("aletta ocean", 1, { order: "most-popular" });
});
</script>
