    ...
    <div class="actor-content">
      <div class="actor-page">
        <div class="page-header">
          <h1 class="page-title">AJ Applegate</h1>
          <p class="page-subtitle">Browse all AJ Applegate videos</p>
        </div>
...
function goToPage(page) {
  ...
  searchVideos('aj applegate', page, { order: 'most-popular' });
...
onMounted(() => {
  searchVideos('aj applegate', 1, { order: 'most-popular' });
});
</script>
