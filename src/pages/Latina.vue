<template>
  <div class="latina-page-container">
    <CategorySidebar :is-open="sidebarOpen" @filter-change="handleFilterChange" />
    <div class="latina-content">
      <div class="latina-page">
        <div class="page-header">
          <h1 class="page-title">Latina</h1>
          <p class="page-subtitle">Browse all Latina videos</p>
        </div>
...
function goToPage(page) {
  ...
  searchVideos('latina', page, { order: 'most-popular' });
  window.scrollTo({ top: 0, behavior: 'smooth' });
}
onMounted(() => { searchVideos('latina', 1, { order: 'most-popular' }); });
</script>

<style scoped>
.latina-page-container { display: flex; position: relative; align-items: flex-start; gap: 0; }
.latina-content { flex: 1; min-width: 0; }
.latina-page { width: 100%; padding: 40px; margin: 0 auto; max-width: 1600px; }
@media (max-width: 1024px) { .latina-content { margin-left: 0; } }
...
@media (max-width: 1024px) { .latina-page { padding: 24px; } }
@media (max-width: 768px) {
  .latina-page { padding: 16px; }
