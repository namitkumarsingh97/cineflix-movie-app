    ...
    <div class="actor-content">
      <div class="actor-page">
        <div class="page-header">
          <h1 class="page-title">Alex Gonz</h1>
          <p class="page-subtitle">Browse all Alex Gonz videos</p>
        </div>
...
function goToPage(page) {
  ...
  searchVideos('alex gonz', page, { order: 'most-popular' });
...
onMounted(() => {
  searchVideos('alex gonz', 1, { order: 'most-popular' });
});
</script>
