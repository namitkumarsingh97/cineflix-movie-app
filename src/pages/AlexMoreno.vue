    ...
    <div class="actor-content">
      <div class="actor-page">
        <div class="page-header">
          <h1 class="page-title">Alex Moreno</h1>
          <p class="page-subtitle">Browse all Alex Moreno videos</p>
        </div>
...
function goToPage(page) {
  ...
  searchVideos('alex moreno', page, { order: 'most-popular' });
...
onMounted(() => {
  searchVideos('alex moreno', 1, { order: 'most-popular' });
});
</script>
