<template>
  <div class="bdsm-page-container">
    ...
    <div class="bdsm-content">
      <div class="bdsm-page">
        <div class="page-header">
          <h1 class="page-title">BDSM</h1>
          <p class="page-subtitle">Browse all BDSM videos</p>
        </div>
...
function goToPage(page) {
  ...
  searchVideos('bdsm', page, { order: 'most-popular' });
...
onMounted(() => {
  searchVideos('bdsm', 1, { order: 'most-popular' });
});
</script>
