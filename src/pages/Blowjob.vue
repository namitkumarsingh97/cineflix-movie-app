<template>
  <div class="blowjob-page-container">
    <!-- Category Sidebar -->
    <CategorySidebar 
      :is-open="sidebarOpen" 
    ...
    <div class="blowjob-content">
      <div class="blowjob-page">
        <div class="page-header">
          <h1 class="page-title">Blowjob</h1>
          <p class="page-subtitle">Browse all Blowjob videos</p>
        </div>
...
function goToPage(page) {
  ...
  searchVideos('blowjob', page, { order: 'most-popular' });
...
onMounted(() => {
  searchVideos('blowjob', 1, { order: 'most-popular' });
});
</script>

<style scoped>
.blowjob-page-container {
  display: flex;
  position: relative;
