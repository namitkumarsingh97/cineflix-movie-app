    ...
    <div class="actor-content">
      <div class="actor-page">
        <div class="page-header">
          <h1 class="page-title">Aaliyah Hadid</h1>
          <p class="page-subtitle">Browse all Aaliyah Hadid videos</p>
        </div>
...
function goToPage(page) {
	...
	searchVideos("aaliyah hadid", page, { order: "most-popular" });
...
onMounted(() => {
	searchVideos("aaliyah hadid", 1, { order: "most-popular" });
});
</script>
