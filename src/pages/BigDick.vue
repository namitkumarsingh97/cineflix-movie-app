<template>
  <div class="bigdick-page-container">
    <!-- Category Sidebar -->
    <CategorySidebar 
      :is-open="sidebarOpen" 
    ...
    <div class="bigdick-content">
      <div class="bigdick-page">
        <div class="page-header">
          <h1 class="page-title">Big Dick</h1>
          <p class="page-subtitle">Browse all Big Dick videos</p>
        </div>
...
function goToPage(page) {
  ...
  searchVideos('big dick', page, { order: 'most-popular' });
...
onMounted(() => {
  searchVideos('big dick', 1, { order: 'most-popular' });
});
</script>

<style scoped>
.bigdick-page-container {
  display: flex;
  position: relative;
