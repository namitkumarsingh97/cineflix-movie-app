<template>
  <div class="massage-page-container">
    ...
    <div class="massage-content">
      <div class="massage-page">
        <div class="page-header">
          ...
          <p class="page-subtitle">Browse all Massage videos</p>
        </div>
...
function goToPage(page) {
  ...
  searchVideos('massage', page, { order: 'most-popular' });
  window.scrollTo({ top: 0, behavior: 'smooth' });
}
onMounted(() => { searchVideos('massage', 1, { order: 'most-popular' }); });
</script>

<style scoped>
.massage-page-container { display: flex; position: relative; align-items: flex-start; gap: 0; }
.massage-content { flex: 1; min-width: 0; }
.massage-page { width: 100%; padding: 40px; margin: 0 auto; max-width: 1600px; }
@media (max-width: 1024px) { .massage-content { margin-left: 0; } }
...
@media (max-width: 1024px) { .massage-page { padding: 24px; } }
@media (max-width: 768px) {
  .massage-page { padding: 16px; }
