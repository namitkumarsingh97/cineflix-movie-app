<template>
  <div class="masturbation-page-container">
    <CategorySidebar :is-open="sidebarOpen" @filter-change="handleFilterChange" />
    <div class="masturbation-content">
      <div class="masturbation-page">
        <div class="page-header">
          <h1 class="page-title">Masturbation</h1>
          <p class="page-subtitle">Browse all Masturbation videos</p>
        </div>
...
function goToPage(page) {
  ...
  searchVideos('masturbation', page, { order: 'most-popular' });
  window.scrollTo({ top: 0, behavior: 'smooth' });
}
onMounted(() => { searchVideos('masturbation', 1, { order: 'most-popular' }); });
</script>

<style scoped>
.masturbation-page-container { display: flex; position: relative; align-items: flex-start; gap: 0; }
.masturbation-content { flex: 1; min-width: 0; }
.masturbation-page { width: 100%; padding: 40px; margin: 0 auto; max-width: 1600px; }
@media (max-width: 1024px) { .masturbation-content { margin-left: 0; } }
...
@media (max-width: 1024px) { .masturbation-page { padding: 24px; } }
@media (max-width: 768px) {
  .masturbation-page { padding: 16px; }
