<template>
  <div class="bigass-page-container">
    <!-- Category Sidebar -->
    <CategorySidebar 
      :is-open="sidebarOpen" 
    ...
    <div class="bigass-content">
      <div class="bigass-page">
        <div class="page-header">
          <h1 class="page-title">Big Ass</h1>
          <p class="page-subtitle">Browse all Big Ass videos</p>
        </div>
...
function goToPage(page) {
	...
	searchVideos("big ass", page, { order: "most-popular" });
...
onMounted(() => {
	searchVideos("big ass", 1, { order: "most-popular" });
});
</script>

<style scoped>
.bigass-page-container {
  display: flex;
  position: relative;
