<template>
  <div class="bigtits-page-container">
    <!-- Category Sidebar -->
    <CategorySidebar 
      :is-open="sidebarOpen" 
    ...
    <div class="bigtits-content">
      <div class="bigtits-page">
        <div class="page-header">
          <h1 class="page-title">Big Tits</h1>
          <p class="page-subtitle">Browse all Big Tits videos</p>
        </div>
...
function goToPage(page) {
  ...
  searchVideos('big tits', page, { order: 'most-popular' });
...
onMounted(() => {
  searchVideos('big tits', 1, { order: 'most-popular' });
});
</script>

<style scoped>
.bigtits-page-container {
  display: flex;
  position: relative;
