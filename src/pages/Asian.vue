<template>
  <div class="asian-page-container">
    <!-- Category Sidebar -->
    <CategorySidebar 
      :is-open="sidebarOpen" 
    ...
    <div class="asian-content">
      <div class="asian-page">
        <div class="page-header">
          <h1 class="page-title">Asian</h1>
          <p class="page-subtitle">Browse all Asian videos</p>
        </div>
...
function goToPage(page) {
	...
	searchVideos("asian", page, { order: "most-popular" });
...
onMounted(() => {
	searchVideos("asian", 1, { order: "most-popular" });
});
</script>

<style scoped>
.asian-page-container {
  display: flex;
  position: relative;
