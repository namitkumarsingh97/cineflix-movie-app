    ...
    <div class="public-content">
      <div class="public-page">
        <div class="page-header">
          ...
          <p class="page-subtitle">Browse all Public videos</p>
        </div>
...
function goToPage(page) {
  ...
  searchVideos('public', page, { order: 'most-popular' });
  window.scrollTo({ top: 0, behavior: 'smooth' });
}
onMounted(() => { searchVideos('public', 1, { order: 'most-popular' }); });
</script>

<style scoped>
.public-page-container { display: flex; position: relative; align-items: flex-start; gap: 0; }
.public-content { flex: 1; min-width: 0; }
.public-page { width: 100%; padding: 40px; margin: 0 auto; max-width: 1600px; }
@media (max-width: 1024px) { .public-content { margin-left: 0; } }
...
@media (max-width: 1024px) { .public-page { padding: 24px; } }
