    ...
    <div class="actor-content">
      <div class="actor-page">
        <div class="page-header">
          <h1 class="page-title">Alex Blake</h1>
          <p class="page-subtitle">Browse all Alex Blake videos</p>
        </div>
...
function goToPage(page) {
	...
	searchVideos("alex blake", page, { order: "most-popular" });
...
onMounted(() => {
	searchVideos("alex blake", 1, { order: "most-popular" });
});
</script>
