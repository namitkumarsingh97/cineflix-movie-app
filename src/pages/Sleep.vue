<template>
  <div class="sleep-page-container">
    ...
    <div class="sleep-content">
      <div class="sleep-page">
        <div class="page-header">
          ...
          <p class="page-subtitle">Browse all Sleep videos</p>
        </div>
...
function goToPage(page) {
  ...
  searchVideos('sleep', page, { order: 'most-popular' });
  window.scrollTo({ top: 0, behavior: 'smooth' });
}
onMounted(() => { searchVideos('sleep', 1, { order: 'most-popular' }); });
</script>

<style scoped>
.sleep-page-container { display: flex; position: relative; align-items: flex-start; gap: 0; }
.sleep-content { flex: 1; min-width: 0; }
.sleep-page { width: 100%; padding: 40px; margin: 0 auto; max-width: 1600px; }
@media (max-width: 1024px) { .sleep-content { margin-left: 0; } }
...
@media (max-width: 1024px) { .sleep-page { padding: 24px; } }
@media (max-width: 768px) {
  .sleep-page { padding: 16px; }
