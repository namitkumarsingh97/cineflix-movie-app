    ...
    <div class="actor-content">
      <div class="actor-page">
        <div class="page-header">
          <h1 class="page-title">Adria Rae</h1>
          <p class="page-subtitle">Browse all Adria Rae videos</p>
        </div>
...
function goToPage(page) {
  ...
  searchVideos('adria rae', page, { order: 'most-popular' });
...
onMounted(() => {
  searchVideos('adria rae', 1, { order: 'most-popular' });
});
</script>
