    ...
    <div class="actor-content">
      <div class="actor-page">
        <div class="page-header">
          <h1 class="page-title">Alex Tanner</h1>
          <p class="page-subtitle">Browse all Alex Tanner videos</p>
        </div>
...
function goToPage(page) {
  ...
  searchVideos('alex tanner', page, { order: 'most-popular' });
...
onMounted(() => {
  searchVideos('alex tanner', 1, { order: 'most-popular' });
});
</script>
