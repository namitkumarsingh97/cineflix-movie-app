    ...
    <div class="actor-content">
      <div class="actor-page">
        <div class="page-header">
          <h1 class="page-title">Adira Allure</h1>
          <p class="page-subtitle">Browse all Adira Allure videos</p>
        </div>
...
function goToPage(page) {
	...
	searchVideos("adira allure", page, { order: "most-popular" });
...
onMounted(() => {
	searchVideos("adira allure", 1, { order: "most-popular" });
});
</script>
