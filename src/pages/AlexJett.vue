    ...
    <div class="actor-content">
      <div class="actor-page">
        <div class="page-header">
          <h1 class="page-title">Alex Jett</h1>
          <p class="page-subtitle">Browse all Alex Jett videos</p>
        </div>
...
function goToPage(page) {
  ...
  searchVideos('alex jett', page, { order: 'most-popular' });
...
onMounted(() => {
  searchVideos('alex jett', 1, { order: 'most-popular' });
});
</script>
