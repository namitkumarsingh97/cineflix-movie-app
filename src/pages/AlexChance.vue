    ...
    <div class="actor-content">
      <div class="actor-page">
        <div class="page-header">
          <h1 class="page-title">Alex Chance</h1>
          <p class="page-subtitle">Browse all Alex Chance videos</p>
        </div>
...
function goToPage(page) {
	...
	searchVideos("alex chance", page, { order: "most-popular" });
...
onMounted(() => {
	searchVideos("alex chance", 1, { order: "most-popular" });
});
</script>
