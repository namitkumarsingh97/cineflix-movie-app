    ...
    <div class="category-content">
      <div class="category-page">
        <div class="page-header">
          <h1 class="page-title">Webcam</h1>
          <p class="page-subtitle">Browse live streaming webcam content</p>
        </div>
...
function goToPage(page) { if (page === '...' || page < 1 || page > totalPages.value) return; searchVideos('webcam', page, { order: 'most-popular' }); window.scrollTo({ top: 0, behavior: 'smooth' }); }
onMounted(() => { searchVideos('webcam', 1, { order: 'most-popular' }); });
</script>
<style scoped>
