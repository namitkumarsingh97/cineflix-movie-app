<template>
  <div class="mature-page-container">
    <CategorySidebar :is-open="sidebarOpen" @filter-change="handleFilterChange" />
    <div class="mature-content">
      <div class="mature-page">
        <div class="page-header">
          <h1 class="page-title">Mature</h1>
          <p class="page-subtitle">Browse all Mature videos</p>
        </div>
...
function goToPage(page) {
  ...
  searchVideos('mature', page, { order: 'most-popular' });
  window.scrollTo({ top: 0, behavior: 'smooth' });
}
onMounted(() => { searchVideos('mature', 1, { order: 'most-popular' }); });
</script>

<style scoped>
.mature-page-container { display: flex; position: relative; align-items: flex-start; gap: 0; }
.mature-content { flex: 1; min-width: 0; }
.mature-page { width: 100%; padding: 40px; margin: 0 auto; max-width: 1600px; }
@media (max-width: 1024px) { .mature-content { margin-left: 0; } }
...
@media (max-width: 1024px) { .mature-page { padding: 24px; } }
@media (max-width: 768px) {
  .mature-page { padding: 16px; }
