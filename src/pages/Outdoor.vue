<template>
  <div class="outdoor-page-container">
    ...
    <div class="outdoor-content">
      <div class="outdoor-page">
        <div class="page-header">
          ...
          <p class="page-subtitle">Browse all Outdoor videos</p>
        </div>
...
function goToPage(page) {
  ...
  searchVideos('outdoor', page, { order: 'most-popular' });
  window.scrollTo({ top: 0, behavior: 'smooth' });
}
onMounted(() => { searchVideos('outdoor', 1, { order: 'most-popular' }); });
</script>

<style scoped>
.outdoor-page-container { display: flex; position: relative; align-items: flex-start; gap: 0; }
.outdoor-content { flex: 1; min-width: 0; }
.outdoor-page { width: 100%; padding: 40px; margin: 0 auto; max-width: 1600px; }
@media (max-width: 1024px) { .outdoor-content { margin-left: 0; } }
...
@media (max-width: 1024px) { .outdoor-page { padding: 24px; } }
@media (max-width: 768px) {
  .outdoor-page { padding: 16px; }
