    ...
    <div class="actor-content">
      <div class="actor-page">
        <div class="page-header">
          <h1 class="page-title">Alex Legend</h1>
          <p class="page-subtitle">Browse all Alex Legend videos</p>
        </div>
...
function goToPage(page) {
  ...
  searchVideos('alex legend', page, { order: 'most-popular' });
...
onMounted(() => {
  searchVideos('alex legend', 1, { order: 'most-popular' });
});
</script>
