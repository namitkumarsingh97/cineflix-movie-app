    ...
    <div class="category-content">
      <div class="category-page">
        <div class="page-header">
          <h1 class="page-title">Verified Amateur</h1>
          <p class="page-subtitle">Browse verified amateur content</p>
        </div>
...
const displayTotalPages = computed(() =>
	totalPages.value > 1000 ? "1000+" : totalPages.value.toString(),
);
const visiblePages = computed(() => {
	const pages = [],
		total = Math.min(totalPages.value, 1000),
...
function goToPage(page) {
	...
	searchVideos("verified amateur", page, { order: "most-popular" });
	window.scrollTo({ top: 0, behavior: "smooth" });
}
onMounted(() => {
	searchVideos("verified amateur", 1, { order: "most-popular" });
});
</script>
<style scoped>
