    ...
    <div class="actor-content">
      <div class="actor-page">
        <div class="page-header">
          <h1 class="page-title">Adriana Chechik</h1>
          <p class="page-subtitle">Browse all Adriana Chechik videos</p>
        </div>
...
function goToPage(page) {
	...
	searchVideos("adriana chechik", page, { order: "most-popular" });
...
onMounted(() => {
	searchVideos("adriana chechik", 1, { order: "most-popular" });
});
</script>
