<template>
  <div class="blonde-page-container">
    <!-- Category Sidebar -->
    <CategorySidebar 
      :is-open="sidebarOpen" 
    ...
    <div class="blonde-content">
      <div class="blonde-page">
        <div class="page-header">
          <h1 class="page-title">Blonde</h1>
          <p class="page-subtitle">Browse all Blonde videos</p>
        </div>
...
function goToPage(page) {
  ...
  searchVideos('blonde', page, { order: 'most-popular' });
...
onMounted(() => {
  searchVideos('blonde', 1, { order: 'most-popular' });
});
</script>

<style scoped>
.blonde-page-container {
  display: flex;
  position: relative;
