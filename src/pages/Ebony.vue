<template>
  <div class="ebony-page-container">
    <CategorySidebar :is-open="sidebarOpen" @filter-change="handleFilterChange" />
    <div class="ebony-content">
      <div class="ebony-page">
        <div class="page-header">
          <h1 class="page-title">Ebony</h1>
          <p class="page-subtitle">Browse all Ebony videos</p>
        </div>
...
function goToPage(page) {
  ...
  searchVideos('ebony', page, { order: 'most-popular' });
  window.scrollTo({ top: 0, behavior: 'smooth' });
}
onMounted(() => { searchVideos('ebony', 1, { order: 'most-popular' }); });
</script>

<style scoped>
.ebony-page-container { display: flex; position: relative; align-items: flex-start; gap: 0; }
.ebony-content { flex: 1; min-width: 0; }
.ebony-page { width: 100%; padding: 40px; margin: 0 auto; max-width: 1600px; }
@media (max-width: 1024px) { .ebony-content { margin-left: 0; } }
...
@media (max-width: 1024px) { .ebony-page { padding: 24px; } }
@media (max-width: 768px) {
  .ebony-page { padding: 16px; }
