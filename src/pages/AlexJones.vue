    ...
    <div class="actor-content">
      <div class="actor-page">
        <div class="page-header">
          <h1 class="page-title">Alex Jones</h1>
          <p class="page-subtitle">Browse all Alex Jones videos</p>
        </div>
...
function goToPage(page) {
	...
	searchVideos("alex jones", page, { order: "most-popular" });
...
onMounted(() => {
	searchVideos("alex jones", 1, { order: "most-popular" });
});
</script>
