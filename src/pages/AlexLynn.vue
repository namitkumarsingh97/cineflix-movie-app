    ...
    <div class="actor-content">
      <div class="actor-page">
        <div class="page-header">
          <h1 class="page-title">Alex Lynn</h1>
          <p class="page-subtitle">Browse all Alex Lynn videos</p>
        </div>
...
function goToPage(page) {
  ...
  searchVideos('alex lynn', page, { order: 'most-popular' });
...
onMounted(() => {
  searchVideos('alex lynn', 1, { order: 'most-popular' });
});
</script>
