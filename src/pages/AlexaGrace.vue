    ...
    <div class="actor-content">
      <div class="actor-page">
        <div class="page-header">
          <h1 class="page-title">Alexa Grace</h1>
          <p class="page-subtitle">Browse all Alexa Grace videos</p>
        </div>
...
function goToPage(page) {
  ...
  searchVideos('alexa grace', page, { order: 'most-popular' });
...
onMounted(() => {
  searchVideos('alexa grace', 1, { order: 'most-popular' });
});
</script>
