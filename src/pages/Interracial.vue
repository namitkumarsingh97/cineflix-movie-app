<template>
  <div class="interracial-page-container">
    <CategorySidebar :is-open="sidebarOpen" @filter-change="handleFilterChange" />
    <div class="interracial-content">
      <div class="interracial-page">
        <div class="page-header">
          <h1 class="page-title">Interracial</h1>
          <p class="page-subtitle">Browse all Interracial videos</p>
        </div>
...
function goToPage(page) {
  ...
  searchVideos('interracial', page, { order: 'most-popular' });
  window.scrollTo({ top: 0, behavior: 'smooth' });
}
onMounted(() => { searchVideos('interracial', 1, { order: 'most-popular' }); });
</script>

<style scoped>
.interracial-page-container { display: flex; position: relative; align-items: flex-start; gap: 0; }
.interracial-content { flex: 1; min-width: 0; }
.interracial-page { width: 100%; padding: 40px; margin: 0 auto; max-width: 1600px; }
@media (max-width: 1024px) { .interracial-content { margin-left: 0; } }
...
@media (max-width: 1024px) { .interracial-page { padding: 24px; } }
@media (max-width: 768px) {
  .interracial-page { padding: 16px; }
